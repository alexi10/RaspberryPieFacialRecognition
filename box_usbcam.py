	...
	while True:
		...
		if box.is_button_up():
			if not box.is_locked:
				...
				#os.system ("sudo fswebcam --greyscale --no-banner -r 1280x960 image.jpg")
				os.system ("sudo fswebcam --no-banner -r 1280x960 image.jpg")
				# os.system ("sudo fswebcam -r 640x480 image.jpg &")
				# os.system("sudo fswebcam --no-banner --scale 50x50 -d /dev/video0 image.jpg &")			
